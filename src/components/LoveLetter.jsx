      ...
      >
        ...
        <div className="text-center overflow-y-auto custom-scrollbar pr-2">
          ...
          <div className="text-gray-700 leading-relaxed font-serif text-lg text-left">
            <p>
              મારી ખાસ વ્યક્તિ, હજી તું મારી પત્ની નથી બની, પણ દિલમાં તારો સ્થાન
              પહેલેથી જ પાકું થઈ ગયું છે. તારી વાતોમાં શાંતિ છે, તારા સ્મિતમાં
              મારી દુનિયા છે. તારી સાથે ભવિષ્યની કલ્પના કરું ત્યારે બધું વધુ
              સુંદર લાગે છે. આપણે હજી સફરની શરૂઆતમાં છીએ, પણ મને પૂરો વિશ્વાસ છે
              કે આ સફર પ્રેમ, સમજ અને ખુશીઓથી ભરેલી હશે. ધીમે ધીમે, હાથમાં હાથ
              રાખીને, આપણે આપણું જીવન સાથે બનાવીએ — બસ એટલું જ મને સૌથી વધુ ખુશ
              કરે છે.
            </p>
            <br />
            <p>
